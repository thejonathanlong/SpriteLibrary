...
//
//        let projectListViewController = HostedViewController(contentView: ProjectsSplitView(projectListViewModel: ProjectListViewModel(dataService: spriteBookDataService)))
